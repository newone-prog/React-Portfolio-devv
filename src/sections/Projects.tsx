...
const Projects = () => {
    ...
    return (
        ...
        >
                ...
                {projectsConfig.projects.map((project) => (
                    ...
                    >
                        ...
                        <div className="absolute bottom-0 left-0 w-full p-6 lg:p-8">
                            <p className="museo-label text-white/50 mb-2 text-[10px]">{project.date}</p>
            ...
            {/* CTA */}
            {projectsConfig.ctaText && (
                <div ref={ctaRef} className="max-w-7xl mx-auto mt-12 flex justify-center">
                    <a
                        href="https://github.com/newone-prog"
                        target="_blank"
                        rel="noopener noreferrer"
                        data-cursor="hover"
                        className="museo-label text-white border border-white/20 px-10 py-4 hover:bg-white hover:text-[#050505] transition-all duration-300 inline-block"
                    >
                        {projectsConfig.ctaText}
                    </a>
                </div>
